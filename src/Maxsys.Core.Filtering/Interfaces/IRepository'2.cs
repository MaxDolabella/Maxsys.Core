    ...
    where TFilter : IFilter<TEntity>
{
    ...
    /// <summary>
    /// Obtém uma quantidade de objetos a partir de um filtro e critérios de listagem (ColumnFilters + Search pós-projeção).
    /// </summary>
    /// <param name="filters"></param>
    /// <param name="criteria"></param>
    /// <param name="cancellation"></param>
    /// <returns></returns>
    ValueTask<int> CountAsync<TDestination>(TFilter filters, ListCriteria criteria, CancellationToken cancellation = default) where TDestination : class;
