...
**Maxsys.Excel** complementa o pacote **Maxsys.Core** com a manipulação de arquivos Excel via *ClosedXML*, oferecendo leitura tipada de tabelas/planilhas através de um mapeamento declarativo (`TableTypeConfigurationBase`, `TableTypeBuilder`) e do `WorkbookFacade`.

## :dart: Target
`.NET 10`

## :package: Nuget
![Nuget](https://img.shields.io/nuget/v/Maxsys.Excel)

```xml
    <PackageReference Include="Maxsys.Excel" Version="17.0.0" />
```
