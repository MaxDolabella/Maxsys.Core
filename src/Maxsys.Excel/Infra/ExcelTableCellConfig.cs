...
{
    public static ExcelTableCellConfig<T> Create<TValue>(Expression<Func<T, TValue>> propertySelector, int columnNumber, ExcelCellDataType dataType, Func<object?, dynamic?>? customConversion = null, string? format = null)
    {
