...
public static class ServiceCollectionExtensions
{
    ...
    {
        /// <summary>
        /// Registra as implementações (públicas ou internal) das interfaces públicas que herdam da interface <typeparamref name="TInterface"/>.<br/>
        ...
        public IServiceCollection AddImplementations<TInterface>(Assembly[] interfaceAssemblies, Assembly[] implementationAssemblies, string? suffix = null, Func<Type, bool>? predicate = null)
            where TInterface : class
        {
            ...
            return services.RegisterImplementationDictionary(implementationDictionary);
        }
        ...
        /// <param name="predicate"></param>
        /// <returns>A mesma instância de <paramref name="services"/> após a operação completada.</returns>
        public IServiceCollection AddImplementations<TInterface, TInterfaceEntry, TImplementationEntry>(string? suffix = null, Func<Type, bool>? predicate = null)
            where TInterface : class
        {
            ...
            return services.AddImplementations<TInterface>(interfaceAssemblies, implementationAssemblies, suffix, predicate);
        }
        ...
        /// <param name="predicate"></param>
        /// <returns>A mesma instância de <paramref name="services"/> após a operação completada.</returns>
        public IServiceCollection AddImplementations<TInterface, TEntry>(string? suffix = null, Func<Type, bool>? predicate = null)
            where TInterface : class
        {
            return services.AddImplementations<TInterface, TEntry, TEntry>(suffix, predicate);
        }
        ...
        /// <param name="lifetime">The <see cref="ServiceLifetime"/> of the service.</param>
        /// <returns>A reference to this instance after the operation has completed.</returns>
        public IServiceCollection Add<TService>(ServiceLifetime lifetime)
            where TService : class
        {
        ...
        /// <returns></returns>
        public IServiceCollection RegisterImplementationDictionary(IReadOnlyDictionary<Type, Type> keyValues, ServiceLifetime serviceLifetime = ServiceLifetime.Scoped)
        {
        ...
        /// <param name="serviceLifetime"></param>
        /// <returns></returns>
        public IServiceCollection ReplaceServiceImplementation<TService, TReplaceImplementation>(ServiceLifetime serviceLifetime = ServiceLifetime.Scoped)
             where TService : class
             where TReplaceImplementation : class, TService
        {
            return services.ReplaceServiceImplementation<TService, TReplaceImplementation>(null, serviceLifetime);
        }

        public IServiceCollection ReplaceServiceImplementation<TService, TReplaceImplementation>(
