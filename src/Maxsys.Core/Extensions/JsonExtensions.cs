...
public static class JsonExtensions
{
    ...
    extension(string? json)
    {
        ...
        public T FromJson<T>(T defaultValue)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public object FromJson(Type returnType)
        {
            object? result = default;
        ...
        public bool TryFromJson<T>([NotNullWhen(true)] out T? obj, [NotNullWhen(false)] out Notification? notification, JsonSerializerOptions? options = null)
        {
