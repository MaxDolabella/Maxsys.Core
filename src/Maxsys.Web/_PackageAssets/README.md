...
**Maxsys.Web** complementa o pacote **Maxsys.Core** com recursos para projetos *ASP.NET Core*: `ApiControllerBase` (respostas padronizadas a partir de `OperationResult`), *health checks*, *model binders* (`FromJson`) e *extensions* para `IFormFile`, `HttpContext` e `IMvcBuilder`.

## :dart: Target
`.NET 10`

## :package: Nuget
![Nuget](https://img.shields.io/nuget/v/Maxsys.Web)

```xml
    <PackageReference Include="Maxsys.Web" Version="17.0.0" />
```
