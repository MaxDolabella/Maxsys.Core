...
public static class IMvcBuilderExtensions
{
    extension(IMvcBuilder builder)
    {
        ...
        /// </summary>
        public IMvcBuilder ConfigureJsonOptions(bool usesJsonStringEnumConverter = true)
        {
            if (usesJsonStringEnumConverter && !JSON_DEFAULT_OPTIONS.Converters.Any(c => c is JsonStringEnumConverter))
            {
